...
const VocabularySlice = createSlice({
    ...
    reducers: {
        ...
        updateFlashcardStatus: (
            state,
            action: PayloadAction<{ wordId: string; status: string }>,
        ) => {
            const card = state.flashcards.find(
                (f) => f.word.id === action.payload.wordId,
            );
...
export const { clearFlashcards, clearWordList, updateFlashcardStatus } =
...
export const selectFlashcards = (s: VocabRootState): Flashcard[] =>
    s.vocabulary.flashcards;
...
export const selectWordList = (s: VocabRootState): VocabularyWord[] =>
    s.vocabulary.wordList;

export const selectWordListStatus = (s: VocabRootState): AsyncStatus =>
    s.vocabulary.wordListStatus;

export const selectWordListError = (s: VocabRootState): string | null =>
    s.vocabulary.wordListError;

export const selectVocabProgress = (s: VocabRootState): VocabUserProgress | null =>
    s.vocabulary.userProgress;

export const selectReviewStatus = (s: VocabRootState): AsyncStatus =>
    s.vocabulary.reviewStatus;