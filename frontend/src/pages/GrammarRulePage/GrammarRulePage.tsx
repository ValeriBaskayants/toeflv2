            ...
            {signalWords.length > 0 && (
                <section className={styles['overviewSection']}>
                    ...
                    <div className={styles['signalWordsList']}>
                        {signalWords.map((w) => (
                            <span key={w} className={styles['signalWord']}>{w}</span>
                        ))}
                    </div>
                </section>
            )}
            ...
            {comparisons.map((comp, i) => (
                ...
                >
                    ...
                    <button
                        ...
                        onClick={() => { onNavigate(comp.compareWith); }}
                    >
                        <Link2 size={12} />
        ...
        <div className={styles['page']}>
            ...
            <div className={styles['body']}>
                ...
                <div className={styles['main']}>
                    ...
                    <div className={styles['tabBar']} role="tablist">
                        {TABS.map(({ key, label, icon }) => (
                            <button
                                ...
                                style={activeTab === key ? { '--tab-color': accentColor } as React.CSSProperties : undefined}
                    ...
                    {activeTab === 'usages' && (
                        <UsagesTab usages={rule.usages} sections={rule.sections} />
                    )}
                    {activeTab === 'mistakes' && (
                        <MistakesTab mistakes={rule.commonMistakes} />
                    )}
                    {activeTab === 'compare' && (
                        <CompareTab
