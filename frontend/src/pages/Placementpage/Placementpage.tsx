...
const LEVEL_COLOR: Record<string, string> = {
    A1: '#22c55e', A1_PLUS: '#16a34a',
    A2: '#14b8a6', A2_PLUS: '#0d9488',
    B1: '#3b82f6', B1_PLUS: '#2563eb',
    B2: '#6366f1', B2_PLUS: '#4f46e5',
    C1: '#8b5cf6', C2: '#a855f7',
};
    ...
    return (
        <div className={styles['centeredView']}>
            ...
            <p className={styles['errorMsg']}>
                Your test session was lost when the page was refreshed.
                Please return to the Dashboard — the test can be restarted
    ...
    return (
        <div className={styles['resultsView']}>
            <div className={styles['resultsInner']}>
                ...
                {/* Stats */}
                <p className={styles['resultsStat']}>
                    Answered {questionsAnswered} adaptive questions
                </p>
...
export function PlacementPage() {
    ...
    if (isLoadingStatus || !statusLoaded || isStarting) {
        return (
            <div className={styles['page']}>
                <LoadingView
                    label={isStarting ? 'Preparing your first question…' : 'Loading…'}
                />
            </div>
        );
    }
            ...
            >
                ...
                <p className={styles['hintText']}>
                    {isAnswering
                        ...
                        : 'Select the best answer — click to submit'}
                </p>
            </div>
        </div>
    );
