...
export const selectGrammarRulesList = (state: { grammar: GrammarRulesState }) =>
    state.grammar.list;
...
export const selectGrammarSearch = (state: { grammar: GrammarRulesState }) =>
    state.grammar.search;
