...
import { BookOpen, Clock, AlignLeft, Search, RefreshCw, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className={styles['page']}>
      <header className={styles['pageHeader']}>
        <div>
          <h1 className={styles['pageTitle']}>{t('reading.title', 'Reading')}</h1>
