...
import {
    ...
    CheckCircle2, XCircle, Zap, RefreshCw, AlertCircle, Loader2,
} from 'lucide-react';
...
const useAppSelector = useAppSelectorBase as unknown as (<T>(selector: (state: ReadingsRootState) => T) => T);
            ...
            <div className={styles['results']}>
                ...
                <div className={styles['scoreStats']}>
                    <div className={styles['scoreStat']}>
                        ...
                        <span>{correctCount} / {questions.length} {t('reading.correct', 'correct')}</span>
                    </div>
                    <div className={styles['scoreStat']}>
                ...
                <div className={styles['reviewList']}>
                    {results.map((res) => {
                        ...
                        return (
                            <div key={res.questionIdx} className={`${styles['reviewCard']} ${res.isCorrect ? styles['reviewOk'] : styles['reviewErr']}`}>
        ...
        <div className={styles['quiz']}>
            <div className={styles['quizHeader']}>
                <h2 className={styles['quizTitle']}>
                    {t('reading.questions', 'Comprehension Check')}
                </h2>
